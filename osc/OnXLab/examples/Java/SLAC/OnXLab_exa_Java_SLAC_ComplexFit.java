...
public class OnXLab_exa_Java_SLAC_ComplexFit
{
  public static void main(String[] argv) throws java.io.IOException
  {
    ...
    IFunction func = funcFactory.createFunctionFromScript("twoDdistr",2,"N*(a*exp( -(x[0]-mu0)*(x[0]-mu0)/(2*s0*s0) )+"
							  ...
							  +"(x[1]-mu2)/(2*s2*s2) )","N,a,mu0,s0,mu1,s1,mu2,s2","",""); //FIXME : SLAC passes null for last arg, but it crashes SWIG wrapping.
    if(func==null) { //FIXME
