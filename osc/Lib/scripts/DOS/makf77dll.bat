...
REM #//////////////////////////////////////////////////////////
REM #// Used by Lib to produce dll for FORTRAN function.     //
REM #//////////////////////////////////////////////////////////
...
F77 /nologo /MD /compile /obj:%bin%%FILE_NAME%.obj %FILE_NAME%.%SUFFIX% 1> f77_exe_error
...
LINK /nologo /OPT:NOREF /dll /out:%bin%%FILE_NAME%.dll %bin%%WRAP_NAME%.obj %bin%%FILE_NAME%.obj  1> link_exe_error
