...
REM # ////////////////////////////////////////////////////////////////
REM # /// Check VisualC++ (but not fatal) ////////////////////////////
REM # ////////////////////////////////////////////////////////////////
...
SET gsview_bin_dir=C:\Program Files\Ghostview\gsview

REM # ////////////////////////////////////////////////////////////////
REM # /// Set gsview32 access ////////////////////////////////////////
REM # ////////////////////////////////////////////////////////////////

IF DEFINED PATH GOTO else_if_set_path
  SET PATH=%gsview_bin_dir%
  GOTO end_if_set_path
:else_if_set_path
  SET PATH=%PATH%;%gsview_bin_dir%
:end_if_set_path
