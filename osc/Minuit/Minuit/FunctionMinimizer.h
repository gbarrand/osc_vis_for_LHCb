...
public:
  ...
  virtual FunctionMinimum minimize(const FCNBase&, const std::vector<double>& par, const std::vector<double>& cov, unsigned int nrow, unsigned int strategy, unsigned int maxfcn, double toler) const = 0; 

  //starting values for parameters and covariance matrix and FCN with gradient
  virtual FunctionMinimum minimize(const FCNGradientBase&, const std::vector<double>& par, const std::vector<double>& cov, unsigned int nrow, unsigned int strategy, unsigned int maxfcn, double toler) const = 0; 
