...
void MnUserTransformation::add(const char* name, double val, double err) {
  assert(std::find_if(theParameters.begin(), theParameters.end(), MnParStr(name)) == theParameters.end());
...
void MnUserTransformation::add(const char* name, double val, double err, double low, double up) {
  assert(std::find_if(theParameters.begin(), theParameters.end(), MnParStr(name)) == theParameters.end());
  theExtOfInt.push_back(theParameters.size());
  theCache.push_back(val);
...
void MnUserTransformation::add(const char* name, double val) {
  assert(std::find_if(theParameters.begin(), theParameters.end(), MnParStr(name)) == theParameters.end());
  theCache.push_back(val);
