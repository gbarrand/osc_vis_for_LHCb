#ifndef BatchLab_FS_Manager_h
#define BatchLab_FS_Manager_h
...
public: //Slash::Core::IManager
  ...
  virtual void* cast(const std::string& a_class) const {
    INLIB_IF_CAST(BatchLab::FS::Manager)
...
public: //Slash::Store::IStoreManager
  virtual Slash::Store::ITree* createTree(const std::string& aName,
    ...
    FS::Tree* tree = new FS::Tree(fSession,aName,aReadOnly,aCreateNew,aOptions,
  ...
  virtual Slash::Store::IObject* createObject(
    ...
    out << "BatchLab::FS::Manager::createObject :" 
        << " dummy."
        << std::endl;
    return 0;
  }
...
public:
  ...
  :fName("FS_Manager"),fSession(aSession){}
  virtual ~Manager(){}
private:
  std::string fName;
