...
def Utils_initClasses():
  ...
  SoStyle.initClass()
  comment = 0 # HEPVis_SoMarkerSet.initClass()
  ...
  SoTextVtk.initClass()
  SoGrid.initClass()
  comment = 0 # SoEdgedFaceSet.initClass()
  ...
  SoAxes2D.initClass()
  SoAxes3D.initClass()
  comment = 0 # SoSimpleButton.initClass()
  SoRegion.initClass()
  SoTextRegion.initClass()
  SoImageRegion.initClass()
  SoDisplayRegion.initClass()
  comment = 0 # SoRulerRegion.initClass()
  comment = 0 # SoFormRegion.initClass()
  SoCanvas.initClass()
  SoPage.initClass()

  comment = 0 # SoPainterAction.initClass()
  comment = 0 # SoGL2PSAction.initClass()
  comment = 0 # SoCollectAction.initClass()
  comment = 0 # SoCounterAction.initClass()
