...
#else
class SoQt6dofDevicePressureEvent : public QEvent { //G.Barrand_Qt4
  typedef QEvent inherited; //G.Barrand_Qt4
#endif
public:
...
class SoQt6dofDeviceButtonEvent : public QCustomEvent {
  typedef QCustomEvent inherited;
#else
class SoQt6dofDeviceButtonEvent : public QEvent { //G.Barrand_Qt4
  typedef QEvent inherited; //G.Barrand_Qt4
#endif
public:
