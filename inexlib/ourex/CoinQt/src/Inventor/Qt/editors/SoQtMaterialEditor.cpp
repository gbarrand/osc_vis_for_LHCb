...
SoQtMaterialEditor::SoQtMaterialEditor(Widget parent, const char * name, SbBool embed)
...
SoQtMaterialEditor::SoQtMaterialEditor(Widget parent, const char * const name, SbBool embed, SbBool build)
: inherited(parent, name, embed)
{
  this->internals = new MaterialEditorComponent;
  PRIVATE(this)->api = this;
