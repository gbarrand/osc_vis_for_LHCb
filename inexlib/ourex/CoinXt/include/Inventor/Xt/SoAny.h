...
public:
  ...
  SoXt::FatalErrorCB * setFatalErrorHandler(SoXt::FatalErrorCB * cb, void * userdata);
  SbBool invokeFatalErrorHandler(SbString errmsg, SoXt::FatalErrors errcode);
