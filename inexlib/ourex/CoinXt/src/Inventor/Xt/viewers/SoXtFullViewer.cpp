...
/*!
  \class SoXtFullViewer SoXtFullViewer.h Inventor/Xt/viewers/SoXtFullViewer.h
  \brief The SoXtFullViewer class adds some user interface components to the viewer canvas.
  \ingroup components viewers

  The SoXtFullViewer is an abstract viewer class which extends it's
  superclass (the basic SoXtViewer class) with two major user
  interface additions:
  ...
  user interfaces of the SoXtFullViewer's non-abstract subclasses.
  ...
  applications will use either the SoXtViewer or the
  SoXtRenderArea as their base-level component, and then inherit
  one of these down into one's own "proper" viewer classes.

  The non-abstract subclasses of the SoXtFullViewer class are
  ...
  \sa SoXtConstrainedViewer, SoXtExaminerViewer, SoXtPlaneViewer
*/
...
/*!
  \fn void SoXtFullViewer::createViewerButtons(Widget parent, SbPList * buttonlist)
  ...
  override createViewerButtons() from SoXtExaminerViewer:
...
*/
/*!
  \var SoXtFullViewer::BuildFlag SoXtFullViewer::BUILD_NONE

  Do not add any of the user interface components.
*/
/*!
  \var SoXtFullViewer::BuildFlag SoXtFullViewer::BUILD_DECORATION

  Only build and set up the decorations around the OpenGL canvas.
*/
/*!
  \var SoXtFullViewer::BuildFlag SoXtFullViewer::BUILD_POPUP

  Only build the popup menu. (Activated with the right mousebutton.)
*/
/*!
  \var SoXtFullViewer::BuildFlag SoXtFullViewer::BUILD_ALL

  Build all user interface components of the SoXtFullViewer.
*/

/*!
  \var Widget SoXtFullViewer::leftDecoration
...
/*!
  \var Widget SoXtFullViewer::bottomDecoration
...
/*!
  \var Widget SoXtFullViewer::rightDecoration
...
/*!
  \fn SoXtFullViewer::SoXtFullViewer(Widget parent, const char * name, SbBool embed, SoXtFullViewer::BuildFlag buildFlag, SoXtViewer::Type type, SbBool build)
...
/*!
  \fn SoXtFullViewer::~SoXtFullViewer()

  Destructor.
*/

/*!
  \fn void SoXtFullViewer::setDecoration(const SbBool enable)
...
/*!
  \fn SbBool SoXtFullViewer::isDecoration(void) const
...
/*!
  \fn void SoXtFullViewer::setPopupMenuEnabled(const SbBool enable)
...
/*!
  \fn SbBool SoXtFullViewer::isPopupMenuEnabled(void) const
...
/*!
  \fn Widget SoXtFullViewer::getAppPushButtonParent(void) const
...
/*!
  \fn void SoXtFullViewer::addAppPushButton(Widget newButton)
...
/*!
  \fn void SoXtFullViewer::insertAppPushButton(Widget newButton, int index)
...
/*!
  \fn void SoXtFullViewer::removeAppPushButton(Widget oldButton)
...
/*!
  \fn int SoXtFullViewer::findAppPushButton(Widget oldButton) const
...
/*!
  \fn int SoXtFullViewer::lengthAppPushButton(void) const
...
/*!
  \fn Widget SoXtFullViewer::getRenderAreaWidget(void) const

  Returns the render area OpenGL canvas widget.
*/

/*!
  \fn void SoXtFullViewer::buildDecoration(Widget parent)

  Build viewer decorations.
*/

/*!
  \fn Widget SoXtFullViewer::buildLeftTrim(Widget parent)
...
/*!
  \fn Widget SoXtFullViewer::buildBottomTrim(Widget parent)
...
/*!
  \fn Widget SoXtFullViewer::buildRightTrim(Widget parent)
...
/*!
  \fn Widget SoXtFullViewer::buildAppButtons(Widget parent)
...
/*!
  \fn Widget SoXtFullViewer::buildViewerButtons(Widget parent)

  Build and layout viewer specified button row.
*/

/*!
  \fn void SoXtFullViewer::buildPopupMenu(void)
...
/*!
  \fn void SoXtFullViewer::openPopupMenu(const SbVec2s position)

  NOTE: This method is not part of the original InventorXt API.
*/

/*!
  \fn void SoXtFullViewer::setLeftWheelString(const char * const string)

  Set label of the left thumbwheel.
*/

/*!
  \fn void SoXtFullViewer::setBottomWheelString(const char * const string)

  Set label of the bottom thumbwheel.
*/

/*!
  \fn void SoXtFullViewer::setRightWheelString(const char * const string)
...
SoXtFullViewer::setLeftWheelValue(const float value)
{
  ...
  if (this->leftWheel) {
    SoXtFullViewerP::setThumbWheelValue(this->leftWheel, value);
  }
}
...
SoXtFullViewer::setBottomWheelValue(const float value)
{
  ...
  // set*WheelValue() is used from subclasses.
  if (this->bottomWheel) {
    SoXtFullViewerP::setThumbWheelValue(this->bottomWheel, value);
  }
}
...
SoXtFullViewer::setRightWheelValue(const float value)
{
  ...
  // set*WheelValue() is used from subclasses.
  if (this->rightWheel) {
    SoXtFullViewerP::setThumbWheelValue(this->rightWheel, value);
  }
}
...
Widget
SoXtFullViewer::getLeftWheelLabelWidget(void) const
{
...
*/
Widget
SoXtFullViewer::getRightWheelLabelWidget(void) const
{
...
*/
Widget
SoXtFullViewer::getBottomWheelLabelWidget(void) const
{
...
*/
void
SoXtFullViewer::setPopupMenuString(const char * name)
{
...
SbBool
SoXtFullViewer::processSoEvent(const SoEvent * const ev)
{
...
// Doc in superclass.
void
SoXtFullViewer::setComponentCursor(const SoXtCursor & cursor)
{
  // Overridden to apply the new cursor only for the rendering canvas
  // widget. Otherwise, the default SoXtComponent
  ...
  SoXtComponent::setWidgetCursor(this->getGLWidget(), cursor);
}
...
SoGuiFullViewerP::SoGuiFullViewerP(SoXtFullViewer * owner)
{
  this->pub = owner;
}
...
{
  SoXtPopupMenu * menu = SoXtPopupMenu::createInstance();
...
void
SoGuiFullViewerP::prepareMenu(SoXtPopupMenu * menu)
{
  //// Misc. //////////////////////////////////////////////////////////
  ...
  //// Basic drawstyles. //////////////////////////////////////////////
  this->setDrawStyleMenuActivation(SoXtFullViewer::STILL,
                                   PUBLIC(this)->getDrawStyle(SoXtFullViewer::STILL));
  this->setDrawStyleMenuActivation(SoXtFullViewer::INTERACTIVE,
                                   PUBLIC(this)->getDrawStyle(SoXtFullViewer::INTERACTIVE));
  ...
  const SoXtViewer::StereoType type = PUBLIC(this)->getStereoType();
  switch (type) {
  case SoXtViewer::STEREO_NONE:
    menu->setMenuItemMarked(STEREO_OFF_ITEM, TRUE);
    break;
  case SoXtViewer::STEREO_ANAGLYPH:
    menu->setMenuItemMarked(STEREO_ANAGLYPH_ITEM, TRUE);
    break;
  case SoXtViewer::STEREO_QUADBUFFER:
    menu->setMenuItemMarked(STEREO_QUADBUFFER_ITEM, TRUE);
    break;
  case SoXtViewer::STEREO_INTERLEAVED_ROWS:
    menu->setMenuItemMarked(STEREO_INTERLEAVED_ROWS_ITEM, TRUE);
    break;
  case SoXtViewer::STEREO_INTERLEAVED_COLUMNS:
...
SoGuiFullViewerP::menuSelection(int menuitemid)
{
  ...
  case VIEW_ALL_ITEM:
    ...
    break;
  case SEEK_ITEM:
    ((SoXtFullViewerP *)this)->seekbuttonClicked();
    break;
  ...
  case STEREO_OFF_ITEM:
    ok = PUBLIC(this)->setStereoType(SoXtViewer::STEREO_NONE);
    assert(ok);
    break;
  case STEREO_ANAGLYPH_ITEM:
    ok = PUBLIC(this)->setStereoType(SoXtViewer::STEREO_ANAGLYPH);
    assert(ok && "anaglyph stereo should always be possible");
    break;
  case STEREO_QUADBUFFER_ITEM:
    ok = PUBLIC(this)->setStereoType(SoXtViewer::STEREO_QUADBUFFER);
    if (!ok) { PUBLIC(this)->setStereoType(SoXtViewer::STEREO_NONE); }
    break;
  case STEREO_INTERLEAVED_ROWS_ITEM:
    ok = PUBLIC(this)->setStereoType(SoXtViewer::STEREO_INTERLEAVED_ROWS);
    if (!ok) { PUBLIC(this)->setStereoType(SoXtViewer::STEREO_NONE); }
    break;
  case STEREO_INTERLEAVED_COLUMNS_ITEM:
    ok = PUBLIC(this)->setStereoType(SoXtViewer::STEREO_INTERLEAVED_COLUMNS);
    if (!ok) { PUBLIC(this)->setStereoType(SoXtViewer::STEREO_NONE); }
    break;
                                             ...
                                             SoXtViewer::DrawStyle value)
{
  ...
  case SoXtViewer::INTERACTIVE:
    switch (value) {
    case SoXtViewer::VIEW_SAME_AS_STILL:
...
SoGuiFullViewerP::drawstyleActivated(int menuitemid)
{
  switch (menuitemid) {
  case SINGLE_BUFFER_ITEM:
    PUBLIC(this)->setBufferingType(SoXtViewer::BUFFER_SINGLE);
    return;
  case DOUBLE_BUFFER_ITEM:
    PUBLIC(this)->setBufferingType(SoXtViewer::BUFFER_DOUBLE);
    return;
  case INTERACTIVE_BUFFER_ITEM:
    PUBLIC(this)->setBufferingType(SoXtViewer::BUFFER_INTERACTIVE);
    return;
  default:
    break;
  }
  ...
  SoXtViewer::DrawStyle val = SoXtViewer::VIEW_AS_IS;
  switch (menuitemid) {
  case AS_IS_ITEM:
    val = SoXtViewer::VIEW_AS_IS;
    break;
  case HIDDEN_LINE_ITEM:
    val = SoXtViewer::VIEW_HIDDEN_LINE;
    break;
  case WIREFRAME_OVERLAY_ITEM:
    val = SoXtViewer::VIEW_WIREFRAME_OVERLAY;
    break;
  case NO_TEXTURE_ITEM:
    val = SoXtViewer::VIEW_NO_TEXTURE;
    break;
  case LOW_RESOLUTION_ITEM:
    val = SoXtViewer::VIEW_LOW_COMPLEXITY;
    break;
  case WIREFRAME_ITEM:
    val = SoXtViewer::VIEW_LINE;
    break;
  case POINTS_ITEM:
    val = SoXtViewer::VIEW_POINT;
    break;
  case BOUNDING_BOX_ITEM:
    val = SoXtViewer::VIEW_BBOX;
    break;

  case MOVE_SAME_AS_STILL_ITEM:
    val = SoXtViewer::VIEW_SAME_AS_STILL;
    break;
  case MOVE_NO_TEXTURE_ITEM:
    val = SoXtViewer::VIEW_NO_TEXTURE;
    break;
  ...
  case MOVE_WIREFRAME_ITEM:
    ...
    break;
  case MOVE_LOW_RES_WIREFRAME_ITEM:
    val = SoXtViewer::VIEW_LOW_RES_LINE;
    break;
  case MOVE_POINTS_ITEM:
    val = SoXtViewer::VIEW_POINT;
    break;
  case MOVE_LOW_RES_POINTS_ITEM:
    val = SoXtViewer::VIEW_LOW_RES_POINT;
    break;
  case MOVE_BOUNDING_BOX_ITEM:
    val = SoXtViewer::VIEW_BBOX;
    break;
  ...
  SoXtViewer::DrawType type = SoXtViewer::STILL;
