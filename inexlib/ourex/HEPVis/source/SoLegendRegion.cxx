...
ACTION(SoLegendRegion,SoBaseKit,SoCallbackAction,callback)
ACTION(SoLegendRegion,SoBaseKit,SoGLRenderAction,GLRender)
ACTION(SoLegendRegion,SoBaseKit,SoGetBoundingBoxAction,getBoundingBox)
ACTION(SoLegendRegion,SoBaseKit,SoGetMatrixAction,getMatrix)
ACTION(SoLegendRegion,SoBaseKit,SoHandleEventAction,handleEvent)
ACTION(SoLegendRegion,SoBaseKit,SoRayPickAction,rayPick)
ACTION(SoLegendRegion,SoBaseKit,SoPickAction,pick)
...
ACTION2(SoLegendRegion,SoBaseKit,SoSearchAction,search)
//ACTION2(SoLegendRegion,SoBaseKit,SoWriteAction,write)
...
void SoLegendRegion::updateChildren(){
  ...
  if(verbose.getValue()==TRUE) {
    SoDebugError::postInfo("SoLegendRegion::doAction",
