...
ACTION(SoInfosRegion,SoBaseKit,SoCallbackAction,callback)
ACTION(SoInfosRegion,SoBaseKit,SoGLRenderAction,GLRender)
ACTION(SoInfosRegion,SoBaseKit,SoGetBoundingBoxAction,getBoundingBox)
ACTION(SoInfosRegion,SoBaseKit,SoGetMatrixAction,getMatrix)
ACTION(SoInfosRegion,SoBaseKit,SoHandleEventAction,handleEvent)
ACTION(SoInfosRegion,SoBaseKit,SoRayPickAction,rayPick)
ACTION(SoInfosRegion,SoBaseKit,SoPickAction,pick)
...
ACTION2(SoInfosRegion,SoBaseKit,SoSearchAction,search)
//ACTION2(SoInfosRegion,SoBaseKit,SoWriteAction,write)
...
void SoInfosRegion::updateChildren(){
  ...
  if(verbose.getValue()==TRUE) {
    SoDebugError::postInfo("SoInfosRegion::updateChildren",
