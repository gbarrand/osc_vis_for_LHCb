...
void SoPlotterRegion::doAction(SoAction* aAction){
  ...
  if(verbose.getValue()==TRUE) {
    SoDebugError::postInfo("SoPlotterRegion::doAction","%lu (%d).",
...
ACTION(SoPlotterRegion,SoBaseKit,SoCallbackAction,callback)
ACTION(SoPlotterRegion,SoBaseKit,SoGLRenderAction,GLRender)
ACTION(SoPlotterRegion,SoBaseKit,SoGetBoundingBoxAction,getBoundingBox)
ACTION(SoPlotterRegion,SoBaseKit,SoGetMatrixAction,getMatrix)
ACTION(SoPlotterRegion,SoBaseKit,SoHandleEventAction,handleEvent)
ACTION(SoPlotterRegion,SoBaseKit,SoRayPickAction,rayPick)
ACTION(SoPlotterRegion,SoBaseKit,SoPickAction,pick)
...
ACTION2(SoPlotterRegion,SoBaseKit,SoSearchAction,search)
//ACTION2(SoPlotterRegion,SoBaseKit,SoWriteAction,write)
