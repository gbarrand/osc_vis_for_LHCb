...
class SbFacet {
 ...
 public:
  ...
  inline void GetEdge(int i,int& v,int& f) const { //G.Barrand
    v = edge[i].v;
    f = edge[i].f;
  }

  inline void Set(int v[8]) //G.Barrand 
...
class SbPolyhedron {
 ...
 public:
  ...
  inline HVPoint3D* GetPV() const {return pV;} //G.Barrand
  inline SbFacet* GetPF() const {return pF;} //G.Barrand
